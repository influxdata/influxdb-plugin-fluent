...
### Dependencies
1. [#43](https://github.com/influxdata/influxdb-plugin-fluent/pull/43): Update dependencies:
    - influxdb-client to 2.9.0

## 1.10.0 [2022-12-01]

### Dependencies
1. [#42](https://github.com/influxdata/influxdb-plugin-fluent/pull/42): Update dependencies:
